...
A screenshot of a visionOS app in Simulator displaying one center window, with a button labeled 'Open a new window', and two smaller translucent windows on either side labeled 'New window number 0' and 'New window number 1'.
