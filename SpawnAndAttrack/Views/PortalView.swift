...
// Import the shared environment factory
// Ensure EnvironmentFactory.swift is part of your target and module
...
//                    updatePortalSize(width: size.x, height: size.y)
    ...
    @MainActor func createPortal() async {
        ...
        do {
            // Pass appModel to createEnvironment(on:)
            //            try await createEnvironment(on: world, appModel: appModel)
            //            root.addChild(world)
